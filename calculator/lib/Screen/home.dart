        ...
        appBar: AppBar(
          ...
          title: Padding(
            ...
            child: Text(
              "Calculator",
              style:
                  TextStyle(color: Theme.of(context).shadowColor, fontSize: 40),
            ),
          ),
          elevation: 0,
          actions: [ChangeMode()],
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Button("AC", Theme.of(context).buttonColor,
                        Theme.of(context).cardColor),
                    Button("%", Theme.of(context).accentColor,
                        Theme.of(context).cardColor),
                    Button("/", Theme.of(context).accentColor,
                        Theme.of(context).cardColor),
                  ],
                ...
                Row(
                  ...
                  children: [
                    ...
                    Button("x", Theme.of(context).accentColor,
                        Theme.of(context).cardColor),
                  ],
                ),
                Spacer(),
                ...
                Row(
                  ...
                  children: [
                    Button(
                        "0", Theme.of(context).primaryColor, Colors.white, 2.2),
